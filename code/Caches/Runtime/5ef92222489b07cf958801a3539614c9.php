                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box grey">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-reorder"></i>菜单新增</div>
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="<?PHP echo "?m=menu&a=add&act=save";?>" id="form_menu_1" method='post' enctype="application/x-www-form-urlencoded" class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><?php echo \struggle\L("name");?><span class="required">*</span></label>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><?php echo \struggle\L("icon");?></label>

                                        <div class="controls">

                                            <input name="icon" type="text" class="span6 m-wrap"/>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><?php echo \struggle\L("desc");?></label>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><?php echo \struggle\L("orderby");?></label>

                                        <div class="controls">

                                            <input name="orderby" type="text" class="span6 m-wrap"/>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><?php echo \struggle\L("ctl_id");?></label>

                                        <div class="controls">

                                            <select class="span6 m-wrap" name="ctl_id">

                                                <option value="">请选择...</option>
                                                <?php foreach($ctl AS $value):?>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><?php echo \struggle\L("act_id");?></label>

                                        <div class="controls">

                                            <select class="span6 m-wrap" name="act_id">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label"><?php echo \struggle\L("parent_id");?><span class="required">*</span></label>
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <button type="submit" class="btn green"><?php echo \struggle\L("confirm");?></button>

                                        <button type="button" class="btn" onclick='location.href="<?PHP echo "?m=menu&a=index";?>"'><?php echo \struggle\L("cancel");?></button>
