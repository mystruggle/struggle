...
class Menu extends Controller{
    ...
    private function _getListData(){
        ...
        foreach ($aData as $data){
            $sEditUrl = Route::self()->genUrl('menu/update?id='.$data['id']);
            $sDelUrl  = Route::self()->genUrl('menu/delete?id='.$data['id']);
    ...
    public function _beforeAction(){
        ...
        $sJs = 'jQuery(document).ready(function() {
					...
					{"bSortable":false,"bSearch":""}],
					"dataUrl":"'.urlencode(Route::self()->genUrl('menu/index?act=getListData')).'",
