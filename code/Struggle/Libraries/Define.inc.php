...
defined('APP_THEME')     or define('APP_THEME',APP_PATH.'Themes/');
defined('APP_PUBLIC')    or define('APP_PUBLIC',$sFrontend.'Public/');
defined('APP_LIB')       or define('APP_LIB',APP_PATH.'AddOnes/');
defined('APP_CONF')      or define('APP_CONF',APP_PATH.'Config/');
