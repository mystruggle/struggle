...
class Model extends Object{
    ...
    protected $mCharset = '';
	private   $mDrvFileSuffix = '.class.php';
    ...
    protected function _init(){
		...
		$this->mPort   = \Struggle\C('DB_PORT')?\Struggle\C('DB_PORT'):'3306';
	...
	*/
	...
	public function validate($data = ''){
		$oValid = Validate::self();
		$oValid->validate($this->data,$this->rules);
		if($oValid->error){
			$this->mError = $oValid->error;
			return false;
		}
		return true;
	}
