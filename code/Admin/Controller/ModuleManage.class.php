...
class ModuleManage extends Controller{
    ...
    private function _getListData(){
        ...
        foreach ($aData as $data){
            $sEditUrl = Route::self()->genUrl('moduleManage/update?id='.$data['id']);
            $sDelUrl  = Route::self()->genUrl('moduleManage/delete?id='.$data['id']);
    ...
    public function _beforeAction(){
        ...
        $sJs = 'jQuery(document).ready(function() {
					...
					{"bSortable":false}],
					"dataUrl":"'.urlencode(Route::self()->genUrl('ModuleManage/index?act=getListData')).'",
